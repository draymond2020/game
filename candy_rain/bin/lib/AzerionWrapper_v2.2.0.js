(() => {
    ...
    var __webpack_modules__ = {
            ...
            var r = (s.prototype.isValidType = function (e) {
                ...
                if (t) {
                    if (this.isValidType(e) && this.isValidHandler(t)) {
                        var r = this._eventHandlers[e];
                        if (r && r.length) for (var s = 0; s < r.length; s++) if (r[s] === t) {
                            r.splice(s, 1);
                            break
                        }
                    }
                ...
                if (e && this.isValidType(e)) {
                    var r = this._eventHandlers[e];
                    if (r && r.length) for (var s = this.createEvent(e, t), a = 0, n = r; a < n.length; a++) {
                        var i = n[a];
                ...
                return void 0 === r && (r = !1), {type: e, data: t, timestamp: Date.now(), once: r}
            }, s);
        ...
        "./src/Wrapper.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./node_modules/@billjs/event-emitter/lib/index.js"), n = r("./src/constants/InterfaceType.ts"),
                i = s(r("./src/constants/style/UIStyle.ts")), o = r("./src/events/InterfaceEvent.ts"),
                d = s(r("./src/events/WrapperEvent.ts")), l = s(r("./src/interface/FBInstant/FBInstantInterface.ts")),
                c = s(r("./src/interface/GCBXPromo.ts/GCBXPromoInterface.ts")),
                u = s(r("./src/interface/SGHooks/SGHooksInterface.ts")),
                f = s(r("./src/interface/SGSDK/SGSDKInterface.ts")), p = s(r("./src/ui/CountdownTag.ts")),
                g = s(r("./src/ui/loading/ADPreloader.ts")), _ = s(r("./src/ui/options/FoldReloader.ts")),
                m = s(r("./src/ui/SupportPopup.ts"));

            class h extends a.EventEmitter {
                constructor() {
                    super(), this.isReady = !1, this["interface"] = new a.EventEmitter, i["default"].setupUIStyle()
                }
                ...
                async init(e) {
                    ...
                    await this.storageManager.initialize(this.config), this.createInterface(e["interface"]), await this.initAds(), this.config.inAppPurchase && await this.initIAP(), (window.sgWrapper = this).createUI(e), this.initOnceAllReady()
                }
                ...
                async onStartGame() {
                    ...
                    e && (console.log(e), this.commsManager.checkPlatformSupport(e)), this.fire(d["default"].GAME_START)
                }
        ...
        "./src/constants/InterfaceType.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.InterfaceType = void 0, (t = t.InterfaceType || (t.InterfaceType = {})).SG_HOOKS = "SG_Hooks", t.SGSDK = "sgSdk", t.FBInstant = "FBInstant"
        },
        "./src/constants/Paths.ts": (e, t) => {
            ...
            (t["default"] = r).platformConfig = "platform-config.json", r.ratingImage = "lib/00_assets/grac_kr_rating_all.png", r.softgamesLogo = "lib/00_assets/softgames_logo.png", r.supportPopupBG = "lib/00_assets/support_popup.png", r.supportPopupTextFrame = "lib/00_assets/support_text_frame.png", r.supportPopupCloseBtn = "lib/00_assets/support_close_button.png", r.firebaseConfig = "firebaseConfig.json"
        },
        "./src/constants/PlatformType.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.PlatformType = void 0, (t = t.PlatformType || (t.PlatformType = {})).SAMSUNG_INSTANT = "samsung", t.AZERION = "azerion", t.WEB = "web"
        },
        "./src/constants/links.ts": (e, t) => {
            var r;
            Object.defineProperty(t, "__esModule", {value: !0}), t.LinksKR = t.Links = void 0, (r = t.Links || (t.Links = {})).TOS = "https://www.softgames.com/terms-of-use/", r.PRIVACYPOLICY = "https://www.softgames.de/privacy/", (t = t.LinksKR || (t.LinksKR = {})).TOS = "https://www.softgames.com/terms-of-use-kr/", t.PRIVACYPOLICY = "https://www.softgames.com/privacy-kr/"
        },
  ...
  `
        ...
        "./src/events/AdManagerEvent.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.AdManagerEvent = void 0, (t = t.AdManagerEvent || (t.AdManagerEvent = {})).AD_ERROR = "AD_ERROR", t.AD_LOADED = "AD_LOADED", t.AD_START = "AD_START", t.AD_SKIP = "AD_SKIP", t.AD_COMPLETE = "AD_COMPLETE", t.AD_CLOSE = "AD_CLOSE", t.INTERSTITIAL_AD_REQUESTED = "INTERSTITIAL_AD_REQUESTED", t.REWARDED_AD_REQUESTED = "REWARDED_AD_REQUESTED", t.AD_REQUESTED = "AD_REQUESTED", t.FREE_REWARD_AWARDED = "FREE_REWARD_AWARDED"
        },
        "./src/events/AdTimerEvent.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.AdTimerEvent = void 0, (t = t.AdTimerEvent || (t.AdTimerEvent = {})).COOLDOWN_START = "COOLDOWN_START", t.COOLDOWN_END = "COOLDOWN_END", t.LONGPLAY_TRIGGER = "LONGPLAY_TRIGGER", t.LONGPLAY_TICKER_START = "LONGPLAY_TICKER_START", t.LONGPLAY_TICKER_STOP = "LONGPLAY_TICKER_STOP", t.LONGPLAY_TICK = "LONGPLAY_TICK", t.LONGPLAY_WARN_TICK = "LONGPLAY_WARN_TICK", t.LONGPLAY_WARN = "LONGPLAY_WARN"
        },
        "./src/events/GameEvent.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.GameEvent = void 0, (t = t.GameEvent || (t.GameEvent = {})).LEVEL_START = "LEVEL_START", t.LEVEL_FINISH = "LEVEL_FINISH", t.GAME_START = "GAME_START", t.GAME_OVER = "GAME_OVER"
        },
        "./src/events/InterfaceEvent.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.InterfaceEvent = void 0, (t = t.InterfaceEvent || (t.InterfaceEvent = {})).LOADED = "GAME_LOADED", t.LOAD_PROGRESS = "LOAD_PROGRESS"
        },
        "./src/events/WrapperEvent.ts": (e, t) => {
            ...
            (t["default"] = r).SDK_INIT = "SDK_INIT", r.SPLASH_HIDDEN = "SPLASH_HIDDEN", r.REQUEST_AD = "REQUEST_AD", r.GAME_START = "GAME_START", r.GAME_PAUSE = "GAME_PAUSE", r.GAME_RESUME = "GAME_RESUME", r.READY = "WRAPPER_READY"
        },
        "./src/index/indexAzerion.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/constants/PlatformType.ts"), n = r("./src/leaderboards/LeaderboardTypes.ts"),
                ...
                u = s(r("./src/platforms/azerion/ui/AzerionSGPreloader.ts")), f = s(r("./src/Wrapper.ts"));

            class p extends s(r("./src/index/indexBase.ts"))["default"] {
                async createWrapper(e) {
                    (f["default"].instance.config = e).platform = a.PlatformType.AZERION, f["default"].instance.storageManager = new l["default"], f["default"].instance.commsManager = new o["default"], f["default"].instance.adManager = new i["default"], f["default"].instance.placementIDs = {
                        rewarded: c.AzerionPlacementIDs.REWARDED,
                        interstitial: c.AzerionPlacementIDs.INTERSTITIAL
                    }, f["default"].instance.iapManager = new d["default"], f["default"].instance.SGPreloader = new u["default"](!1), f["default"].instance.init(e), !0 === e.leaderboardSupport && (f["default"].instance.leaderboards = await this.getLeaderboardHandler(n.LeaderboardTypes.FIREBASE)), f["default"].instance.onStart()
                }
            }
        ...
        "./src/index/indexBase.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = s(r("./src/constants/Paths.ts")), n = s(r("./src/Wrapper.ts"));
        ...
        "./src/interface/FBInstant/FBInstantInterface.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/events/InterfaceEvent.ts"), n = s(r("./src/Wrapper.ts"));
            ...
            class u extends i["default"] {
                ...
                startGameAsync() {
                    return this.interfaceRef.fire(a.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), n["default"].commsManager.startGame(), Promise.resolve()
                }
                ...
                getLocale() {
                    return console.log("FBInterface locale :: " + n["default"].commsManager.getLanguage()), n["default"].commsManager.getLanguage()
                }
        ...
        "./src/interface/FBInstant/modules/FBPayments.ts": function (e, t, r) {
            ...
            class n {
                async getCatalogAsync() {
                    return a["default"].iapManager.getCatalogAsync()
                }

                async purchaseAsync(e) {
                    return a["default"].iapManager.purchaseAsync(e)
                }

                async getPurchasesAsync() {
                    return a["default"].iapManager.getPurchasesAsync()
                }

                async consumePurchaseAsync(e) {
                    return a["default"].iapManager.consumePurchaseAsync(e)
                }
                ...
                hasIAPSupport() {
                    return a["default"].iapManager.hasIAPSupport()
                }
            }
        ...
        "./src/interface/GCBXPromo.ts/GCBXPromoInterface.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/events/GameEvent.ts"), n = r("./src/events/InterfaceEvent.ts"),
            ...
            class c extends o["default"] {
                constructor(e) {
                    ...
                    }, this.loading = {finished: this.finished.bind(this)}, this.tracking = {
                ...
                finished(e) {
                    return this.interfaceRef.fire(n.InterfaceEvent.LOADED), this.interfaceRef.fire(n.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), Promise.resolve()
                }
                ...
                gameOver(e, t) {
                    this.interfaceRef.fire(a.GameEvent.GAME_OVER, {level: e, score: t}), this.trackScore(e, t)
                }
        ...
        "./src/interface/SGHooks/SGHooksActionType.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.SGHooksActionType = void 0, (t = t.SGHooksActionType || (t.SGHooksActionType = {})).RUN = "runGame", t.PAUSE = "pauseGame", t.UNPAUSE = "unpauseGame"
        },
        "./src/interface/SGHooks/SGHooksInterface.ts": function (__unused_webpack_module, exports, __webpack_require__) {
            ...
            class SGHooksInterface extends InterfaceBase_1["default"] {
                constructor(e) {
                    super(e), Wrapper_1["default"].instance.supportedLanguages = window.gameLangs, this.loadGameScripts(), window.SG_Hooks = this, window.SG = {lang: Wrapper_1["default"].commsManager.getLanguage()}
                }

                start() {
                    this.interfaceRef.fire(InterfaceEvent_1.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), Wrapper_1["default"].commsManager.startGame()
                }
                ...
                setPauseHandler(e) {
                    Wrapper_1["default"].commsManager.setPauseCallback(e), this.observer !== undefined && this.observer({action: SGHooksActionType_1.SGHooksActionType.PAUSE})
                }

                setUnpauseHandler(e) {
                    Wrapper_1["default"].commsManager.setResumeCallback(e), this.observer !== undefined && this.observer({action: SGHooksActionType_1.SGHooksActionType.UNPAUSE})
                }
                ...
                async loaded() {
                    this.interfaceRef.fire(InterfaceEvent_1.InterfaceEvent.LOADED), this.interfaceRef.fire(InterfaceEvent_1.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), this.observer !== undefined && this.observer({action: SGHooksActionType_1.SGHooksActionType.RUN})
                }
                ...
                levelStarted(e, t) {
                    this.interfaceRef.fire(GameEvent_1.GameEvent.LEVEL_START, {level: e}), t && t()
                }

                levelFinished(e, t, r) {
                    this.interfaceRef.fire(GameEvent_1.GameEvent.LEVEL_FINISH, {level: e}), this.trackScore(e, t), r && r()
                }
                ...
                async loadGameScripts() {
                    if (window.gameJS) {
                        for (const e of window.gameJS) await (0, html_1.createHTMLElement)({src: e, tag: "script"});
                        this.initGame()
                    } else this.initGame()
                }
        ...
        "./src/interface/SGSDK/SGSDKInterface.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const n = r("./src/events/GameEvent.ts"), i = r("./src/events/InterfaceEvent.ts"),
                a = s(r("./src/events/WrapperEvent.ts")), o = s(r("./src/Wrapper.ts"));
            ...
            class l extends s["default"] {
                ...
                initialize(e, t, r) {
                    ...
                    let s = {
                        ...
                        config: {env: {locale: o["default"].commsManager.getLanguage()}, rewarded: {enabled: !0}}
                    };
                ...
                async trigger(e, t) {
                    switch (e) {
                        case d.SGSDKTriggers.START:
                            this.interfaceRef.fire(i.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), o["default"].commsManager.startGame();
                            break;
                        case d.SGSDKTriggers.LOADING_COMPLETED:
                            this.interfaceRef.fire(i.InterfaceEvent.LOAD_PROGRESS, {progress: 101}), this.interfaceRef.fire(i.InterfaceEvent.LOADED), this.initData.runGame();
                            break;
                        case d.SGSDKTriggers.LOADING_UPDATE:
                            this.interfaceRef.fire(i.InterfaceEvent.LOAD_PROGRESS, {progress: t.progressPercentage}), 100 <= t.progressPercentage && this.interfaceRef.fire(i.InterfaceEvent.LOADED);
                            break;
                        ...
                        case d.SGSDKTriggers.LEVEL_START:
                            if (this.interfaceRef.fire(n.GameEvent.LEVEL_START, {level: t.level}), t.callback) return void t.callback();
                            break;
                        case d.SGSDKTriggers.LEVEL_FINISH:
                            if (this.interfaceRef.fire(n.GameEvent.LEVEL_FINISH, {level: t.level}), t.callback) return void t.callback();
        ...
        "./src/interface/common/InterfaceBase.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/events/AdManagerEvent.ts"), n = s(r("./src/Wrapper.ts"));
        ...
        "./src/leaderboards/LeaderboardTypes.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.LeaderboardTypes = void 0, (t = t.LeaderboardTypes || (t.LeaderboardTypes = {}))[t.FIREBASE = 0] = "FIREBASE", t[t.SAMSUNG = 1] = "SAMSUNG"
        },
            ...
            class f extends i["default"] {
                ...
                async showRewardedAd() {
                    ...
                    var e = new Promise(async (t, e) => {
                        ...
                        d["default"].i.once(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, r), d["default"].i.once(c.AzerionEvent.SDK_SKIPPED, s), n["default"].sdkHandler.showAd(l.AzerionAdType.REWARDED).then(e => {
                        })["catch"](e => {
        ...
        "./src/platforms/azerion/AzerionCommsManager.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/constants/Default.ts"), n = s(r("./src/events/WrapperEvent.ts")),
                i = r("./src/ui/helpers/html.ts"), o = s(r("./src/Wrapper.ts"));
            ...
            class u extends d["default"] {
                ...
                async initialize() {
                    window.GD_OPTIONS = {
                        gameId: o["default"].config.gameID, prefix: "sg_", onEvent: function (e) {
                    ...
                    var e = new Promise(async (t, e) => {
                        l["default"].i.once(c.AzerionEvent.SDK_READY, () => {
                            if (window.gdsdk) o["default"].sdkHandler = window.gdsdk, console.log(o["default"].sdkHandler), t(!0); else {
                                const e = setInterval(() => {
        ...
        "./src/platforms/common/ADManager.ts": function (e, t, r) {
            ...
            const n = r("./src/events/AdManagerEvent.ts"), i = r("./src/events/AdTimerEvent.ts"),
                o = r("./src/events/GameEvent.ts"), d = s(r("./src/Wrapper.ts"));
        ...
        "./src/platforms/common/AdTimer.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            var a = r("./node_modules/@billjs/event-emitter/lib/index.js");
            const n = s(r("./src/Wrapper.ts")), i = r("./src/events/GameEvent.ts"),
                o = r("./src/events/AdManagerEvent.ts"), d = r("./src/events/AdTimerEvent.ts");
            ...
            class l extends a.EventEmitter {
                ...
                initialize(e) {
                    ...
                    this._ready = !e.startOnCooldown, this.ready || this.startAdCoolDownTimer(), this.handleFreeRewardedTimer(), n["default"].adManager.on(o.AdManagerEvent.AD_SKIP, () => {
                        this.onAdPlayed()
        ...
        "./src/platforms/common/CommsManager.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            var a = r("./node_modules/@billjs/event-emitter/lib/index.js");
            const n = r("./src/constants/InterfaceType.ts"), i = s(r("./src/Wrapper.ts")),
        ...
        "./src/platforms/samsung/utils/UID.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.getUID = void 0, t.getUID = function () {
        ...
        "./src/ui/CountdownTag.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/events/AdManagerEvent.ts"), n = r("./src/events/AdTimerEvent.ts"),
                i = s(r("./src/Wrapper.ts")), o = r("./src/ui/helpers/uiRoot.ts");
        ...
        "./src/ui/SupportPopup.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const l = s(r("./src/constants/Paths.ts")), c = r("./src/ui/texts.ts"), u = s(r("./src/Wrapper.ts")),
                a = r("./src/ui/helpers/uiRoot.ts"), f = r("./src/constants/links.ts");
            ...
            class n {
                constructor() {
                    ...
                    const a = document.createElement("div"), n = document.createElement("div");
                    let i = u["default"].commsManager.getLanguage();
                    c.wrapperLanguages.includes(i) || (i = "en");
                    var o = ("kr" == i ? f.LinksKR : f.Links).TOS, d = ("kr" == i ? f.LinksKR : f.Links).PRIVACYPOLICY;
        ...
        "./src/ui/helpers/html.ts": (e, t) => {
            ...
            Object.defineProperty(t, "__esModule", {value: !0}), t.getParameterByName = t.DOMEventToPromise = t.createHTMLElement = void 0, t.createHTMLElement = async function ({
                                                                                                                                                                                      tag: e,
                                                                                                                                                                                      id: t,
                                                                                                                                                                                      src: r,
                                                                                                                                                                                      style: s,
        ...
        "./src/ui/helpers/uiRoot.ts": (e, t) => {
            ...
            Object.defineProperty(t, "__esModule", {value: !0}), t.getUIRoot = t.createUIRoot = t.UI_ROOT_ELEMENT_ID = void 0, t.UI_ROOT_ELEMENT_ID = "ui-root", t.createUIRoot = r, t.getUIRoot = function () {
        ...
        "./src/ui/loading/SGPreloader.ts": function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", {value: !0});
            const a = r("./src/ui/helpers/uiRoot.ts"), n = s(r("./src/constants/style/UIStyleDefault.ts")),
                i = r("./src/ui/helpers/html.ts"), o = s(r("./src/constants/Paths.ts")),
                d = r("./src/events/InterfaceEvent.ts"), l = s(r("./src/Wrapper.ts"));
        ...
        "./src/ui/texts.ts": (e, t) => {
            Object.defineProperty(t, "__esModule", {value: !0}), t.wrapperLanguages = t.TEXTS = void 0, t.TEXTS = [], t.TEXTS.fr = {
                play: "JOUER",
            ...
            }, t.TEXTS.nl = {play: "SPEEL", tos: "Voorwaarden", privacy: "Privacybeleid"}, t.TEXTS.pl = {
                play: "GRAJ",
                ...
                tos: "Terms & Conditions",
                privacy: "Privacy Policy"
            }, t.TEXTS.ja = {play: "プレイ", tos: "利用規約", privacy: "プライバシーポリシー"}, t.TEXTS.kr = {
                play: "놀다",
                tos: "이용 약관",
                privacy: "개인정보 보호 정책"
            }, t.TEXTS.ar = {
            ...
            const s = function (e) {
                ...
                return function (e) {
                    for (var t = [], r = 32 * e.length, s = "0123456789abcdef", a = 0; a < r; a += 8) {
                        var n = e[a >> 5] >>> a % 32 & 255, n = parseInt(s.charAt(n >>> 4 & 15) + s.charAt(15 & n), 16);
                        t.push(n)
                    }
                    return t
                }(function (e, t) {
        ...
        "./node_modules/uuid/dist/esm-browser/sha1.js": (e, t, r) => {
            ...
            const s = function (e) {
                ...
                for (var u = 0; u < i; ++u) {
                    ...
                    for (var _ = r[0], m = r[1], h = r[2], E = r[3], A = r[4], v = 0; v < 80; ++v) var S = Math.floor(v / 20), S = T(_, 5) + function (e, t, r, s) {
                        switch (e) {
                            case 0:
                                return t & r ^ ~t & s;
                            case 1:
                    ...
                    }(S, m, h, E) + A + t[S] + f[v] >>> 0, A = E, E = h, h = T(m, 30) >>> 0, m = _, _ = S;
        ...
        "./node_modules/uuid/dist/esm-browser/v1.js": (e, t, r) => {
            ...
            var c, u, f = r("./node_modules/uuid/dist/esm-browser/rng.js"),
                p = r("./node_modules/uuid/dist/esm-browser/stringify.js"), g = 0, _ = 0;
            const s = function (e, t, r) {
                var s = t && r || 0, a = t || new Array(16), n = (e = e || {}).node || c,
                ...
                var o = e.msecs !== undefined ? e.msecs : Date.now(), r = e.nsecs !== undefined ? e.nsecs : _ + 1,
                    d = o - g + (r - _) / 1e4;
        ...
        "./node_modules/uuid/dist/esm-browser/v35.js": (e, t, r) => {
            r.r(t), r.d(t, {
                DNS: () => s, URL: () => a, "default": () => function (e, i, o) {
                    function t(e, t, r, s) {
            ...
            var s = "6ba7b810-9dad-11d1-80b4-00c04fd430c8", a = "6ba7b811-9dad-11d1-80b4-00c04fd430c8"
        },
