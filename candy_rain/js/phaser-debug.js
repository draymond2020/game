!function (e) {
    ...
    return function e(t, n, i) {
        ...
        1: [function (e, t, n) {
            var i = e("./util/ui"), a = e("./styles/main.less"), s = e("./panels/Performance"), r = e("./panels/Scene");
            ...
            l.prototype = Object.create(Phaser.Plugin.prototype), l.prototype.constructor = l, l.PKG = e("../package.json"), l.VERSION = l.PKG.version, t.exports = l, l.prototype.init = function () {
                for (var e in this.panels.performance = new s(this.game, this), this.panels.scene = new r(this.game, this), i.addCss(a), document.body.appendChild(this._createElement()), this._bindEvents(), this.timings) for (var t in this.timings[e]) this._wrap(this.game, t, e, t);
                ...
                var e = this._container = document.createElement("div"), t = this._bar = document.createElement("div");
                ...
                var e = document.createElement("span"), t = this.game.renderType,
            ...
            "use strict";
            var i = e("./handlebars/base"), a = e("./handlebars/safe-string").default,
                s = e("./handlebars/exception").default, r = e("./handlebars/utils"), l = e("./handlebars/runtime"),
                o = function () {
            ...
            "use strict";
            var i = e("./utils"), a = e("./exception").default;
            n.VERSION = "2.0.0";
            ...
            var s = i.isArray, r = i.isFunction, l = i.toString;
            ...
            function o(e, t) {
                ...
                this.helpers = e || {}, this.partials = t || {}, (n = this).registerHelper("helperMissing", function () {
                    ...
                    var a = t.inverse, r = t.fn;
                    if (!0 === e) return r(this);
                    if (!1 === e || null == e) return a(this);
                    if (s(e)) return e.length > 0 ? (t.ids && (t.ids = [t.name]), n.helpers.each(e, t)) : a(this);
                    if (t.data && t.ids) {
                        var l = d(t.data);
                        l.contextPath = i.appendContextPath(t.data.contextPath, t.name), t = {data: l}
                    }
                    return r(e, t)
                }), n.registerHelper("each", function (e, t) {
                    if (!t) throw new a("Must pass iterator to #each");
                    var n, l, o = t.fn, h = t.inverse, p = 0, u = "";
                    if (t.data && t.ids && (l = i.appendContextPath(t.data.contextPath, t.ids[0]) + "."), r(e) && (e = e.call(this)), t.data && (n = d(t.data)), e && "object" == typeof e) if (s(e)) for (var c = e.length; p < c; p++) n && (n.index = p, n.first = 0 === p, n.last = p === e.length - 1, l && (n.contextPath = l + p)), u += o(e[p], {data: n}); else for (var f in e) e.hasOwnProperty(f) && (n && (n.key = f, n.index = p, n.first = 0 === p, l && (n.contextPath = l + f)), u += o(e[f], {data: n}), p++);
                    ...
                    if (t.data && t.ids) {
                        var a = d(t.data);
                        a.contextPath = i.appendContextPath(t.data.contextPath, t.ids[0]), t = {data: a}
                    }
                    return n(e, t)
            ...
            n.createFrame = d
        }, {"./exception": 4, "./utils": 7}], 4: [function (e, t, n) {
            "use strict";
            ...
            "use strict";
            var i = e("./utils"), a = e("./exception").default, s = e("./base").COMPILER_REVISION,
                r = e("./base").REVISION_CHANGES, l = e("./base").createFrame;
            ...
            n.checkRevision = function (e) {
                ...
                var n = {
                    ...
                    }, escapeExpression: i.escapeExpression, invokePartial: function (n, s, r, l, o, h, p, d, u) {
                        o && (l = i.extend({}, l, o));
                        var c = t.VM.invokePartial.call(this, n, r, l, h, p, d, u);
                        if (null == c && t.compile) {
                            var f = {helpers: h, partials: p, data: d, depths: u};
                            p[r] = t.compile(n, {data: void 0 !== d, compat: e.compat}, t), c = p[r](l, f)
                        }
                        if (null != c) {
                            if (s) {
                ...
                var o = {partial: !0, helpers: i, partials: s, data: r, depths: l};
                if (void 0 === e) throw new a("The partial " + t + " could not be found");
                if (e instanceof Function) return e(n, o)
            }, n.noop = function () {
                return ""
            }
        }, {"./base": 3, "./exception": 4, "./utils": 7}], 6: [function (e, t, n) {
            "use strict";
        ...
        }, {"./safe-string": 6}], 8: [function (e, t, n) {
            t.exports = e("./dist/cjs/handlebars.runtime")
        }, {"./dist/cjs/handlebars.runtime": 2}], 9: [function (e, t, n) {
            t.exports = e("handlebars/runtime").default
        }, {"handlebars/runtime": 8}], 10: [function (e, t, n) {
            t.exports = {
                name: "phaser-debug",
                version: "1.1.9",
                ...
                dependencies: {handlebars: "^2.0.0", "node-lessify": "^0.0.5", hbsfy: "^2.1.0"},
                devDependencies: {
                    browserify: "^5.11.1",
                    "event-stream": "^3.1.7",
                    gulp: "^3.8.8",
            ...
            t.exports = i.template({
                1: function (e, t, n, i) {
                    ...
                    var a, s = this.lambda, r = this.escapeExpression;
                    ...
                    var a, s, r = t.helperMissing, l = this.escapeExpression, o = this.lambda,
        ...
        }, {"hbsfy/runtime": 9}], 12: [function (e, t, n) {
            var i = e("hbsfy/runtime");
            t.exports = i.template({
                compiler: [6, ">= 2.0.0-beta.1"], main: function (e, t, n, i) {
        ...
        }, {"hbsfy/runtime": 9}], 13: [function (e, t, n) {
            var i = e("hbsfy/runtime");
            t.exports = i.template({
                1: function (e, t, n, i) {
                    ...
                    var a, s, r = t.helperMissing, l = this.escapeExpression,
        ...
        }, {"hbsfy/runtime": 9}], 14: [function (e, t, n) {
            var i = e("../util/ui");
        ...
        }, {"../util/ui": 19}], 15: [function (e, t, n) {
            var i = e("./Panel"), a = e("../util/Graph");

            function s(e, t) {
                i.call(this, e, t), this.name = "performance", this.title = "Performance", this.eventQueue = [], this.graph = null, this.colorPalettes = {_default: ["#058DC7", "#50B432", "#ED561B", "#DDDF00", "#24CBE5", "#64E572", "#FF9655", "#FFF263", "#6AF9C4", "#2b908f", "#90ee7e", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee", "#55BF3B", "#DF5353", "#7798BF", "#aaeeee"]}
            }
        ...
        }, {"../util/Graph": 18, "./Panel": 14}], 16: [function (e, t, n) {
            var i = e("./Panel"), a = e("../util/ui"), s = e("hbsfy/runtime"), r = e("../hbs/scene/panel.hbs"),
                l = e("../hbs/scene/details.hbs"), o = e("../hbs/scene/tree.hbs"), h = {}, p = 0;
            ...
            s.registerPartial("sceneDetails", l), s.registerPartial("sceneTree", o), s.registerHelper("typeString", function () {
                ...
                var e = this.selected.dataset.id, t = h[e];
                if (this.details.innerHTML = l(t), t.texture) {
                    this.details.appendChild(this.bmd.canvas);
                    var n = Math.min(512, t.width), i = Math.min(256, t.height);
            ...
            i.prototype.constructor = i, t.exports = i, i.prototype.addData = function (e, t) {
                ...
                var t = 0, n = 0, i = this.padding, a = 0;
                for (var s in e) for (var r in a = n * this.legendBoxSize + this.padding * (n + 1) + this.padding, this.ctx.fillStyle = this.labelStyle, this.ctx.fillText(s, i, a), ++n, e[s]) a = n * this.legendBoxSize + this.padding * n, this.ctx.fillStyle = this.colors[t++ % this.colors.length], this.ctx.fillRect(i + this.legendIndent, a, this.legendBoxSize, this.legendBoxSize), this.ctx.fillStyle = this.labelStyle, this.ctx.fillText(Math.round(e[s][r]) + "ms - " + r, i + this.legendIndent + this.legendBoxSize + this.padding, a + this.legendBoxSize), ++n > 16 && (i += this.legendWidth / 2, n = 0)
            }, i.prototype.drawData = function (e, t) {
                var n = this.dataCanvas.width - this.dataLineWidth + .5, i = this.dataCanvas.height - .5;
                ...
                var a = 0, s = 0;
                for (var r in e) for (var l in e[r]) this.dctx.beginPath(), this.dctx.strokeStyle = this.dctx.fillStyle = this.colors[a++ % this.colors.length], this.dctx.lineWidth = this.dataLineWidth, s = (s = e[r][l] / this.maxValue * this.dataCanvas.height) < 0 ? 0 : s, this.dctx.moveTo(n, i), this.dctx.lineTo(n, i -= s), this.dctx.stroke();
            ...
            var i = {
                delegate: function (e, t, n, i) {
                    ...
                    -1 !== i && (n.splice(i, 1), e.className = n.join(" ").trim())
                    ...
                    if ("string" == typeof t) e.style[t] = n; else for (var i in t) e.style[i] = t[i]
                }, empty: function (e) {
            ...
            if (t.exports = i, !HTMLElement.prototype.matches) {
                ...
                a.matches = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.msMatchesSelector || a.oMatchesSelector || function (e) {
                    for (var t, n = this.parentElement.querySelectorAll(e), i = 0; t = n[i++];) if (t === this) return !0;
                    return !1
                }
            }
        }, {}]
